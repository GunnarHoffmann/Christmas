...
st.image("https://s3.us-west-2.amazonaws.com/gesundhait.de/bodycomp.png", caption="Withings Body Comp", use_container_width=True)
...
st.image("https://s3.us-west-2.amazonaws.com/gesundhait.de/swnova.png", caption="Withings ScanWatch Nova", use_container_width=True)
